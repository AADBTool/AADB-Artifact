...
#include <queue>
 ...
 int globalWasted_store = 0;
 int globalReorder_store = 0;
 int globaldiffchainedgraphaa_store = 0;
 int run_globaldiffcahinedgraphaa_call_store = 0;
 int globalAcrossCallReorder_store = 0;
 int globalAcrossCallWasted_store = 0;
