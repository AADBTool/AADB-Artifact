...
// std::string fetchAAByPrimaryKey_SLP_multiple(const std::string &ptr1, const std::string &ptr2, const std::string &moduleName = "", const std::string &Opcode = "", const std::string &Opcode1 = "") {
...
//   if(moduleName == "" || ptr1 == "" || ptr2 == "") {
//     return "MayAlias"; // Default to MayAlias if module or function name is empty
//   }  
//   MYSQL* conn = mysql_init(nullptr);
//    key = "&" + ptr1 + "@" + Opcode + "&" + ptr2 + "@" + Opcode1; // Construct key from inputs
// #ifdef DEBUG_PRINT
...
// std::string fetchAAByPrimaryKey_Slp_interprocedural(const std::string &ptr1, const std::string &ptr2, const std::string &moduleName = "", const std::string &Opcode = "", const std::string &Opcode1 = "") {
//   std::string key; // Assuming this is the primary key column name
//   if(moduleName == "" || ptr1 == "" || ptr2 == "") {
...
// uint64_t GetMemId_SLP(Instruction *inst) {
...
// uint64_t GetMemId_SLP_calls(Instruction *inst) {
